...
Asymptote's GitHub integration gives you visibility into your [repositories](/introduction/core-concepts#repository) so it can review pull requests, enforce security [policies](/introduction/core-concepts#policy), and detect [vulnerabilities](/introduction/core-concepts#vulnerability) before they reach production.
...
- [Set up GitHub Security PR Reviews](/deployment/ci-github-actions) to enable GitHub App PR reviews for linked repositories
