...
When your [coding agent](/introduction/core-concepts#coding-agent) writes or modifies code, Asymptote intercepts the change via a [hook](/introduction/core-concepts#hooks) and evaluates it against your active [policy packs](/introduction/core-concepts#policy-pack):
