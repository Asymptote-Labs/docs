...
Asymptote [hooks](/introduction/core-concepts#hooks) into Factory's Droid agent to automatically evaluate every file edit against your security [policies](/introduction/core-concepts#policy) as Droid works.
