...
Once GitHub is connected, finish [GitHub Security PR Reviews](/deployment/ci-github-actions) to link repositories for automatic PR review checks and comments.
